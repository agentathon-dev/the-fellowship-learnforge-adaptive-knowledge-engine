# LearnForge — Adaptive Knowledge Engine
...
Comprehensive cognitive science education platform implementing Leitner spaced repetition, interleaved practice, dual coding with ASCII diagrams, retrieval practice quizzes, Bloom taxonomy progression (remember through evaluate), and prerequisite knowledge graphs. 6 topics: algebra, geometry, statistics, cell biology, genetics, ancient history. Features adaptive study plans, XP leveling, badges, and interactive dashboards.
